...
{
    [ExecuteAlways]
    public class NeoReflection : MonoBehaviour
    {
        [System.Serializable]
        ...
        private void UpdateReflectionCamera(Camera realCamera)
        {
            ...
            float d = -Vector3.Dot(normal, pos) - (m_settings.m_ClipPlaneOffset + NeoOcean.oceanheight);
        ...
        {
            Vector3 offsetPos = pos + normal * (m_settings.m_ClipPlaneOffset + NeoOcean.oceanheight);
